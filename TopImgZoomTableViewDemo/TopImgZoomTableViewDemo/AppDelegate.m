...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ABTopImgTableViewController *vc = [[ABTopImgTableViewController alloc] init];
    self.window.rootViewController = [[ABNavigationController alloc] initWithRootViewController:vc];
